"""
los algoritmos se puede descomponer en partes de alto nivel y en partes de bajo nivel

Este diseño permite habilitar el comportamiento requerido de un sistema en tiempo de ejecución
"""
from abc import ABC
